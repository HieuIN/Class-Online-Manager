<template>
  <div class="ai-agent">
    ...
    <section v-if="open" class="agent-panel">
      ...
      <footer><textarea v-model="input" rows="2" maxlength="4000" :placeholder="placeholder" @keydown.enter.exact.prevent="send()"></textarea><button :disabled="loading||!input.trim()" @click="send()">Gửi</button></footer>
